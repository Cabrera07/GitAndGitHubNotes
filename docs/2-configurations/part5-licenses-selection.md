...
- 🔄 Your project depends on **GPLv2-only code**, as upgrading to **GPLv3** can cause compatibility issues.
...
- 🛡️ You want to **protect contributors' names** from being used for promotional purposes (use **BSD 3-Clause** instead).
